...
def test_generate_index_is_deterministic_and_reuses_unchanged_interfaces(tmp_path: Path) -> None:
    (tmp_path / "forge.yaml").write_text("project: test\n", encoding="utf-8")
    ...
    assert entries["sample.py"]["generated_at"] == "2024-01-02T03:04:05+00:00"
