...
def build_agent_rewrite_prompt(
    ...
    lines = [
        ...
        "Any content written to satisfy a validator must be top-level readable content:",
        "do not put required headings or bullets inside blockquotes, fenced code blocks,",
        "or inline code. If the body quotes an older Diagnosis section, restate the",
        "required Diagnosis content outside the quote as ordinary top-level Markdown.",
        "",
        "Output rules:",
