"""Tests for the plan-review flow, story validation, and plan-agent review.

Covers: human plan review (blocking/advisory/ntfy), story validation,
and automated plan agent review with regen/escalation logic.
"""
