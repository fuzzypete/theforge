...
class TestCmdStatusActiveRuns:
    ...
    def test_shows_single_run_status_for_active_run(self, tmp_path, capsys):
    ...
    def test_shows_sprint_status_for_active_sprint(self, tmp_path, capsys):
    ...
    def test_falls_back_to_historical_sprint_when_no_active(self, tmp_path, capsys):
    ...
    def test_explicit_run_id_resolves_and_shows_status(self, tmp_path, capsys):
    ...
    def test_explicit_run_id_not_found_returns_error(self, tmp_path, capsys):
    ...
    def test_last_flag_shows_most_recent_completed(self, tmp_path, capsys):
        ...
        mock_status = {"phase": "DONE", "cost_usd": 2.50, "elapsed_seconds": 600, "log_path": None}
    ...
    def test_recent_flag_shows_compact_list(self, tmp_path, capsys):
