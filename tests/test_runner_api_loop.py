...
class TestAgentLoopLifecycle:
    ...
    def test_google_adapter_thought_signature_attached_to_fc(self, tmp_path):
        ...
        _, modules, _, _ = self._make_google_modules(fake_client)
        profile = _make_profile(provider="google", model="gemini-2.5-pro-preview-customtools")
    ...
    def test_google_translate_messages_includes_thought_signature(self, tmp_path):
    ...
    def test_google_translate_messages_no_thought_signature_when_absent(self, tmp_path):
...
class TestRunGoogle:
    ...
    def _make_google_modules(self, fake_client):
        """Build sys.modules mocks for google.genai."""
        import sys
    ...
    def test_valid_json_response_succeeds(self):
        ...
        fake_response = self._make_response(text=valid_json)
        fake_client = MagicMock()
        fake_client.models.generate_content.return_value = fake_response

        _, modules = self._make_google_modules(fake_client)
        profile = _make_profile(provider="google", model="gemini-2.5-flash")
    ...
    def test_none_response_text_returns_clear_error(self):
        ...
        fake_response = self._make_response(text=None, finish_reason="STOP", input_tokens=1234)
        fake_client = MagicMock()
        fake_client.models.generate_content.return_value = fake_response
    ...
    def test_blocked_response_surfaces_block_reason(self):
        ...
        fake_response = self._make_response(text=None, block_reason="SAFETY", input_tokens=500)
        fake_client = MagicMock()
        fake_client.models.generate_content.return_value = fake_response
    ...
    def test_empty_unblocked_response_retries_once(self):
        ...
        empty_response = self._make_response(text=None, finish_reason="STOP")
        fake_client = MagicMock()
    ...
    def test_retry_succeeds_on_second_attempt(self):
        ...
        empty_response = self._make_response(text=None, finish_reason="STOP")
        good_response = self._make_response(text=valid_json)
        fake_client = MagicMock()
