...
def render_debrief_section(assembled_context: Any, *, style: str = STYLE_YAML_BLOCK) -> str:
    ...
    parts = [
        ...
        *_DISPOSITION_LINES,
        ...
        "nothing; name the path, the section number, or words that appear in the",
        "commit message or test filename you mean. A pointer that cannot be resolved",
        "is recorded as such — that is a fine outcome, and far better than a vague",
        "one that resolves against the wrong artifact.",
        "",
