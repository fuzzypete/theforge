"""Tests for the coordinator dev phase logic.

Covers: prompt routing (fix vs dev prompt), session resume/carry-through,
budget enforcement for dev and review agents, dev notes, and handoff validation.
"""
    ...
    def test_timeout_resume_dirty_worktree_auto_committed(
        ...
        def shell_side_effect(cmd, cwd, **kwargs):
            ...
            if "git commit" in cmd:
                return (True, "")
            from coord_test_helpers import _handle_stale_check_cmd
